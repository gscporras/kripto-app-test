...
class StatusAdapter(
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        val view: View = convertView ?: layoutInflater.inflate(R.layout.item_status, parent, false)
    ...
    override fun getDropDownView(position: Int, convertView: View?, parent: ViewGroup): View {
        val view: View
        if (position == 0) {
            view = layoutInflater.inflate(R.layout.item_header_status, parent, false)
            ...
            view = layoutInflater.inflate(R.layout.item_status_dropdown, parent, false)
            getItem(position)?.let { country ->
                setItemForHour(view, country)
            }
        }
